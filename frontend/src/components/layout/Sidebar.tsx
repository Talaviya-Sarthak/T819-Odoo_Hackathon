...
const DEFAULT_ROLE_NAV: Record<string, NavItem[]> = {
  ...
  OPS_FINANCE: [
    { name: 'dashboard', label: 'Operations Dashboard', path: '/operations/dashboard', icon: 'dashboard' },
    { name: 'orders', label: 'Sales Orders', path: '/operations/orders', icon: 'orders' },
    { name: 'fulfillment', label: 'Fulfillment', path: '/operations/fulfillment', icon: 'fulfillment' },
    { name: 'inventory', label: 'Inventory', path: '/operations/inventory', icon: 'products' },
    { name: 'backorders', label: 'Backorders', path: '/operations/backorders', icon: 'fulfillment' },
    ...
    { name: 'subscriptions', label: 'Subscriptions', path: '/operations/subscriptions', icon: 'subscriptions' },
  ],
  FINANCE: [
    { name: 'dashboard', label: 'Operations Dashboard', path: '/operations/dashboard', icon: 'dashboard' },
    { name: 'invoices', label: 'Invoices', path: '/operations/invoices', icon: 'invoices' },
