                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-right space-x-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-md border border-border/60 bg-card px-3 py-1.5 text-xs font-semibold text-foreground hover:bg-white/5 transition-colors"
                        >
                          View Details
                        </button>
                        <button
          ...
          <div className="relative w-full max-w-3xl rounded-2xl border border-border/60 bg-card p-6 shadow-2xl space-y-6 my-8 text-foreground animate-in zoom-in-95 duration-150">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 border-t border-border/40 pt-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  onClick={() => setSelectedQuote(null)}
                  className="rounded-lg border border-border/60 bg-card px-4 py-2 text-xs font-semibold text-foreground hover:bg-white/5"
                >
                  Close
                </button>
